...
public class GridSystemVisual : MonoBehaviour
{
    ...
    private void UpdateGridVisual()
    {
        ...
        ShowGridPositionList(selectedAction.GetValidActionGridPosList(), gridVisualType);
    }
    ...
    {
        foreach (GridVisualTypeMaterial gridVisualTypeMaterial in gridVisualTypeList)
        {
            if (gridVisualTypeMaterial.gridVisualType == gridVisualType)
                return gridVisualTypeMaterial.material;
        }

        Debug.LogError("Could not find Grid material for gridType " + gridVisualType);
        return null;
    }
}
